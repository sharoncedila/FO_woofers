class ViewNotificationResponse {
  ...
  ViewNotificationResponse(
      {required this.errorSchema, required this.outputSchema});
...
class ErrorSchema {
  ...
  ErrorSchema({required this.errorCode, required this.errorMessage});
...
class OutputSchema {
  ...
  OutputSchema({required this.notificationList});
