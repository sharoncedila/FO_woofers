...
//       padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 5),
//       child: Column(
//         crossAxisAlignment: recipientId != bubbleChatlistDetail.senderId
//             ? CrossAxisAlignment.end
//             : CrossAxisAlignment.start,
//         children: [
//           BubbleSpecialThree(
//             text: bubbleChatlistDetail.message!,
//             color: recipientId != bubbleChatlistDetail.senderId
//                 ? const Color(0xFF1B97F3)
//                 : const Color(0xFFE8E8EE),
//             tail: false,
//             isSender: recipientId != bubbleChatlistDetail.senderId,
//             textStyle: GoogleFonts.archivoNarrow(
//               fontSize: 17,
//               color: Colors.black,
//               decoration: TextDecoration.none,
